  ...
  return (
    ...
    >
        ...
        <p className="text-base lg:text-lg mt-[21px] max-w-[328px] md:max-w-[600px] lg:max-w-[1000px] flex flex-col gap-1">
            ...
            <span className="font-bold mt-4">{t(data.text_1_4)}</span><br />
            ...
            <span>
                <span className="font-bold ml-6">&bull;</span>
                <span>{" "}{t(data.text_2_3)}</span>
            </span>
            <span className="font-bold mt-4">{t(data.text_2_4)}</span><br />
            ...
            <span>
                <span className="font-bold ml-6">&bull;</span>
                <span>{" "}{t(data.text_3_3)}</span>
            </span>
            <span className="font-bold mt-4">{t(data.text_3_4)}</span><br />
            <span className="text-center font-bold text-xl">{t(data.Conclusion)}</span>
            <span className="font-bold">{t(data.text_4)}</span>
        </p>
    </motion.main>
  )
}
