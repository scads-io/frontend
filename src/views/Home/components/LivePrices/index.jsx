  ...
  return (
    <div className="relative mt-10">
      <div className="mb-10 flex flex-col items-center">
        ...
        <span className={`text-2xl font-medium ${theme && 'text-[#B6B6B6]'}`}>{t('Statistics')}</span>
      </div>
      <div className="flex flex-col items-center justify-center">
        ...
        >
          ...
          >
            <div className="flex flex-col items-center lg:items-start lg:flex-row justify-center gap-8 lg:gap-8 xl:gap-12 2xl:gap-24 py-6 px-7 lg:py-0 lg:px-0 w-[326px] md:w-full rounded-[30px]">
              <div
              ...
              >
                ...
                >
                  <h1 className="font-bold text-center text-xl md:text-2xl xl:text-[32px]">
                    {rewardSpeed.toFixed(7)}
                  </h1>
                </div>
                <div className="flex flex-col w-[135px] md:w-[127px] lg:w-full">
                  <p className={`${theme ? 'text-[#B6B6B6]' : 'text-black'} text-sm md:text-lg font-medium`}>
                    {t('Adaptive Minting')}
                  </p>
