  ...
  return (
    <>
      <div
        className={` ${
          theme.isDark
            ? "md:bg-[url('../images/home/tokenomics_bg_dark.webp')] bg-center bg-cover"
            : "md:bg-[url('../images/home/tokenomics_bg_light.webp')] bg-center bg-cover"
      ...
      >
        {theme.isDark && <img src="images/home/proccess-dark.webp" alt="proccess" />}
        {theme.isDark === false && <img src="images/home/Proccess.webp" alt="proccess" />}
      </motion.div>
    </>
  );
};
