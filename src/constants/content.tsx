...
export const roadmapContent = [
  ...
  },
  {
    id: 'r18',
    date: 'May 2024',
    l1: 'The beginning of developing the technical plan for the zero-knowledge Layer 0 blockchain.',
  },
  {
    id: 'r19',
    date: 'August 2024',
  ...
  },
  {
    id: 'r20',
    date: 'February 2025',
    l1: 'Scads secured wallet.',
    l2: 'LENDING based on user’s own collateral in SCADS for. (Lending does not incur interest only transactions fees.)',
  },
  {
    id: 'r21',
    date: 'March 2025',
...
export const cardItems = [
  ...
  {
    title: 'TWINE',
    description: 'Linearly growing digital asset minted by holding SCADS long-term, secured and trusted investment.',
    path: '/tokenomics/#twine',
  },
  {
    title: 'SEIGNORAGE',
    description: 'Is the difference between the value of money and the cost to produce and distribute it.',
    path: '/tokenomics/#seignorage',
  },
  {
    title: 'PULSE',
...
export const tutorialDesktop = {
  metamask: [
    ...
    {
      label: 'Step 4: Add BNB to your wallet balance to cover gas fees on the network.',
      list: {
...
export const accordionItems = [
  ...
  {
    trigger: "How does SCADS ensure its structure doesn't resemble schemes that could potentially harm investors?",
  ...
  {
    trigger: 'How can institutions and governments fund themselves with (POH) without increasing debt or taxes?',
    content:
