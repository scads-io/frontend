...
import { Text, Button, CloseIcon, IconButton, LinkExternal, Input, Link } from '@scads-io/uikit'
    ...
    <Wrapper>
      <Column style={{ width: '100%', flex: '1 1' }}>
        <AutoColumn gap='14px'>
          ...
          {!isAddressValid && <Text bold color='failure'>{t('Enter valid token address')}</Text>}
          {searchToken && (
            <ImportRow
              token={searchToken}
